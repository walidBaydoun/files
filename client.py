...
class Arena:
    ...
    def _draw_lobby(self):
        ...
        # Chat button
        self.btn_chat_lobby.rect = pygame.Rect(WIN_W - 466, 20, 80, 34)
    ...
    def _draw_over(self):
        ...
        # Card
        cw, ch = 540, 370
        card = pygame.Rect(gcx - cw // 2, gcy - ch // 2 - 8, cw, ch)
        cs = pygame.Surface((cw, ch), pygame.SRCALPHA)
        cs.fill((5, 6, 12, 252))
        self.screen.blit(cs, card.topleft)
